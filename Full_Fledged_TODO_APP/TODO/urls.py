...
urlpatterns = [
    ...
    path(
        "singup/validate_otp_mail/",
        views.validate_mail_otp_view,
        name="validate_mail_otp",
    ),
    path("goal/create_goal/", views.create_goal, name="create_goal"),
    path("goal/update_goal/<int:pk>/", views.update_goal, name="update_goal"),
    path("goal/all_goals", views.all_goals, name="all_goals"),
    path(
        "goal/toggle_goal/<int:pk>", views.toggle_goal_status, name="toggle_goal_status"
    ),
